"""
FastAPI Server Orchestrator for Data Science Analytics Pipeline
Fully compatible with Vercel serverless deployment specifications.
...
def api_generate_data(req: GenerateDataRequest):
    try:
        ...
        # Handle nan values to return clean JSON
...
def api_ingest(req: IngestRequest):
    ...
    try:
        ...
        # Replace NaN values with None for compliant JSON responses
